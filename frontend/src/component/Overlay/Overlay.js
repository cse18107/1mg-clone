...
import Img_2 from '../../images/login_img_2.png';
import Img_3 from '../../images/login_img_3.png';
import Img_4 from '../../images/login_img_4.png';
import Img_5 from '../../images/login_img_5.png';
import "react-responsive-carousel/lib/styles/carousel.min.css"; // requires a loader
import { Carousel } from 'react-responsive-carousel';

export const Overlay = ({setOverlay,mode,setFalse}) => {
  ...
  return (
    <div className="overlay_body">
        ...
        <div className="overlay_content">
          ...
          >
            <div className="overlay-left_content">
              <div className="overlay-left_content-img"><img style={{width:'8rem'}} src={Img_1} alt='img'/></div>
              <div className="overlay-left_content-desc">
                <div className="overlay-left_content-desc__heading">Health Related Queries?</div>
                <div className="overlay-left_content-desc__desc">Consult our certified doctors from anywhere, anytime</div>
                <div className="overlay-left_content-desc__desc overlay-left_content-desc__desc-last">for free. We guarantee your privacy.</div>
              </div>
            </div>
            <div className="overlay-left_content">
              <div className="overlay-left_content-img"><img style={{width:'8rem'}} src={Img_2} alt='img'/></div>
              <div className="overlay-left_content-desc">
                <div className="overlay-left_content-desc__heading">Health Related Queries?</div>
                <div className="overlay-left_content-desc__desc">Consult our certified doctors from anywhere, anytime</div>
                <div className="overlay-left_content-desc__desc overlay-left_content-desc__desc-last">for free. We guarantee your privacy.</div>
            ...
            <div className="overlay-left_content">
              <div className="overlay-left_content-img"><img style={{width:'8rem'}} src={Img_3} alt='img'/></div>
              <div className="overlay-left_content-desc">
                <div className="overlay-left_content-desc__heading">Health Related Queries?</div>
                <div className="overlay-left_content-desc__desc">Consult our certified doctors from anywhere, anytime</div>
                <div className="overlay-left_content-desc__desc overlay-left_content-desc__desc-last">for free. We guarantee your privacy.</div>
            ...
            <div className="overlay-left_content">
              <div className="overlay-left_content-img"><img style={{width:'8rem'}} src={Img_4} alt='img'/></div>
              <div className="overlay-left_content-desc">
                <div className="overlay-left_content-desc__heading">Health Related Queries?</div>
                <div className="overlay-left_content-desc__desc">Consult our certified doctors from anywhere, anytime</div>
                <div className="overlay-left_content-desc__desc overlay-left_content-desc__desc-last">for free. We guarantee your privacy.</div>
            ...
            <div className="overlay-left_content">
              <div className="overlay-left_content-img"><img style={{width:'8rem'}} src={Img_5} alt='img'/></div>
              <div className="overlay-left_content-desc">
                <div className="overlay-left_content-desc__heading">Health Related Queries?</div>
                <div className="overlay-left_content-desc__desc">Consult our certified doctors from anywhere, anytime</div>
                <div className="overlay-left_content-desc__desc overlay-left_content-desc__desc-last">for free. We guarantee your privacy.</div>
          ...
          <div className="overlay_right">
            <div className="overlay_right-cross" onClick={closeOverlay}>×</div>
            <div className="overlay_right_content">
              <div className="overlay_right_content_name">{name}</div>
              ...
              <button className='overlay_right_login_button'>{button}</button>
      ...
      <div className="click_body"  onClick={closeOverlay}></div>
    </div>
  );
};
